...
import productdetails.SmallBangListener;
...
public class SmallBang extends View {
    ...
    public static productdetails.SmallBang attach2Window(Activity activity) {
        ViewGroup rootView = (ViewGroup) activity.findViewById(Window.ID_ANDROID_CONTENT);
       productdetails.SmallBang smallBang = new productdetails.SmallBang(activity);
