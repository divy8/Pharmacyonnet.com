...
//         *******Tabview*********
        ...
        tabLayout.addTab(tabLayout.newTab().setText("groceries & staples"));
        tabLayout.addTab(tabLayout.newTab().setText("foods & snacks"));
        tabLayout.addTab(tabLayout.newTab().setText("beverages"));
        tabLayout.addTab(tabLayout.newTab().setText("imported & gourmet"));
        tabLayout.addTab(tabLayout.newTab().setText("home needs"));
