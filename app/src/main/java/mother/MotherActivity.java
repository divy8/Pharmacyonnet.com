...
//         *******Tabview*********
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Feeding & Nursing"));
        tabLayout.addTab(tabLayout.newTab().setText("diapering & cleansing"));
        tabLayout.addTab(tabLayout.newTab().setText("baby body care"));
        tabLayout.addTab(tabLayout.newTab().setText("baby nutrition"));
        tabLayout.addTab(tabLayout.newTab().setText("Just for mom"));
