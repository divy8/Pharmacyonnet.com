...
//
        ...
        final Runnable r = new Runnable() {
            public void run() {
                ...
                ArrayList<Main_Catagories> ar=new ArrayList<Main_Catagories>();
               // ArrayList<Main_Catagories> childar=new ArrayList<Main_Catagories>();
               // ArrayList<Main_Catagories> child=new ArrayList<Main_Catagories>();
                Main_Catagories mc;
                //Main_Catagories cc;
   ...
   public static void loaddata(final View view)
    {
       ...
       // child_catagoriesArrayList=new ArrayList<Child_catagories>();
        ...
        String url = MainActivity.domain+"/module/applicationdataexport/getcategory?id=42";
