...
//         *******Tabview*********
        ...
        tabLayout.addTab(tabLayout.newTab().setText("bath & shower"));
        tabLayout.addTab(tabLayout.newTab().setText("beauty & makeup"));
        tabLayout.addTab(tabLayout.newTab().setText("feminine & needs"));
        tabLayout.addTab(tabLayout.newTab().setText("masculine & needs"));
