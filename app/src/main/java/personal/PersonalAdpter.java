...
public class PersonalAdpter extends RecyclerView.Adapter<PersonalAdpter.ViewHolder> {

     private ArrayList<Main_Catagories> listItems;
     private Context context;

    public PersonalAdpter(ArrayList<Main_Catagories> listItems, Context context) {
