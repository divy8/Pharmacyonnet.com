...
public class WellnessAdapter extends RecyclerView.Adapter<WellnessAdapter.ViewHolder> {

     private ArrayList<Main_Catagories> listItems;
     private Context context;

    public WellnessAdapter(ArrayList<Main_Catagories> listItems, Context context) {
